...
const SECTIONS = [
  ...
  },
  {
    ...
    body: "We do not share, sell, or provide your mobile phone number or messaging consent data to third parties or affiliates for marketing or promotional purposes.\n\nInformation you submit on a financing application may be shared with lending partners solely to evaluate and fund your request; mobile phone numbers and SMS consent data are never shared for marketing or promotional purposes.\n\nWhen you opt in to SMS communications, we collect your phone number, consent timestamp, and the IP address associated with your consent. My Business Solutions LLC uses this information to send application status and customer care messages.\n\nMessage frequency varies. Message and data rates may apply. Reply STOP to opt out and HELP for help.",
  },
  {
    heading: "In short",
